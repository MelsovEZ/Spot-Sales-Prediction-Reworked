      ...
      <Card className="bg-white border-[#4CAF50] border-t-4">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-sm text-[#4CAF50]">+15% vs yesterday</p>
          </div>
      ...
      <Card className="bg-white border-[#F2CB0A] border-t-4">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-2xl font-bold text-[#F2CB0A]">Big Mac</p>
      ...
      <Card className="bg-white border-[#AD3205] border-t-4">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-sm text-[#AD3205]">3 positions open</p>
          </div>
